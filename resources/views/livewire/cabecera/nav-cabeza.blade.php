                ...
                @auth
                    <form method="POST" action="{{ route('logout') }}" x-data>
                        ...
                        <a href="{{ route('logout') }}" @click.prevent="$root.submit();"
                            class="flex items-center text-sm font-medium border border-transparent text-lime-500  hover:border-white p-3 rounded-sm hover:bg-zinc-700 md:hover:bg-transparent">
