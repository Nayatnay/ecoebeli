    ...
    <x-dialog-modal wire:model="open_edit">
        ...
        <x-slot name="content">
            ...
            <div class=" mb-4">
                ...
                <x-input id="nombre" class="block mt-1 w-full" type="text" name="nombre" wire:model="nombre" required autofocus />
                <x-input-error for="nombre" />
            </div>
            <div class=" mb-4">
                <x-label for="descripcion" value="{{ __('descripcion') }}" class="text-zinc-800" />
                <x-input id="descripcion" class="block mt-1 w-full" type="text" name="descripcion" wire:model="descripcion" required autofocus />
                <x-input-error for="descripcion" />
            </div>
            <div class=" mb-4">
                <x-label for="id_categoria" value="{{ __('Categoría') }}" class="text-zinc-800" />
                <select name="id_categoria" wire:model="id_categoria" class="w-full px-2 py-3 text-sm rounded-md border border-gray-200 focus:border-gray-300 focus:ring-0 text-zinc-800">
            ...
            <div class="flex flex-wrap">
                <div class="mb-4">
                    ...
                    <x-input id="codigo" class="block mt-1" type="text" name="codigo" wire:model="codigo" required autofocus />
                    <x-input-error for="codigo" />
                </div>
                <div class="mb-4 sm:mx-2">
                    <x-label for="stock" value="{{ __('Existencias') }}" class="text-zinc-800" />
                    <x-input id="stock" class="block mt-1 [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none" type="number" step="any" name="stock" wire:model="stock" required autofocus />
            ...
            <div class="flex justify-between items-end mt-4">
                ...
                <img src="{{asset('../storage/productos/'.$imagen)}}" alt="" title="" class="p-4 border border-zinc-500 rounded" width="240">
