    ...
    <x-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div  class="mt-4">
                ...
                <x-input id="doc" class="block mt-1 w-full" type="text" name="doc" :value="old('doc')" required autofocus autocomplete="doc" />
            </div>

            <div class="mt-4">
                <x-label for="pais" value="{{ __('País') }}" />
                <select name="pais" class="block mt-1 w-full text-gray-800 border-gray-200 focus:border-gray-300 focus:ring-0 rounded-md shadow-sm'" type="text" name="pais" :value="old('pais')" required autofocus autocomplete="pais">
            ...
            <div  class="mt-4">
                ...
                <x-input id="ciudad" class="block mt-1 w-full" type="text" name="ciudad" :value="old('ciudad')" required autofocus autocomplete="ciudad" />
            </div>

            <div  class="mt-4">
                <x-label for="estado" value="{{ __('Estado / Provincia') }}" />
            ...
            <div  class="mt-4">
                ...
                <x-input id="cp" class="block mt-1 w-full" type="text" name="cp" :value="old('cp')" required autofocus autocomplete="cp" />
            </div>

            <div  class="mt-4">
                <x-label for="telf" value="{{ __('Teléfono Personal') }}" />
                <x-input id="telf" class="block mt-1 w-full" type="text" name="telf" :value="old('telf')" required autofocus autocomplete="telf" />
            </div>
