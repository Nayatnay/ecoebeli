...
<body class="antialised">
    ...
    <div class="max-w-screen-xl mx-auto">
        ...
        <div class="mt-8 text-sm font-medium p-2 flex items-center justify-end">
                <p class="">Ordenar por</p>
                <select name="filtroprecio" id="filtroprecio" class="font-normal text-sm border-none focus:ring-0 focus:outline-none hover:cursor-pointer hover:text-orange-600 bg-transparent">
